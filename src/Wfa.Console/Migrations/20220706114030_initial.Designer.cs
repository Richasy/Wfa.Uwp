...
namespace Wfa.Console.Migrations
{
    ...
    [Migration("20220706114030_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wfa.Models.Community.Arcane", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Wfa.Models.Community.ArcaneEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ArcaneId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Wfa.Models.Community.ArcaneEffect", b =>
                {
                    b.HasOne("Wfa.Models.Community.Arcane", null)
                        .WithMany("Effects")
                        .HasForeignKey("ArcaneId")
